...
Everything below the rule is the script. Output it word for word as your first
message of the session, then wait for the user's answer before starting step 1.
